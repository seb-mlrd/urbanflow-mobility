...
export default function ProfilPage() {
  ...
  const transportSubtitle =
    transportModes.length > 0 ? transportModes.join(', ') : 'Aucun mode sélectionné';
      ...
      >
        ...
        >
          ...
          >
            ...
            <path
              d="M6 31c0-6.627 5.373-12 12-12s12 5.373 12 12"
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
            />
            ...
            >
              <div className="flex flex-wrap gap-2 pt-4">
                {TRANSPORT_MODES.map((mode) => {
                  const active = editingModes
                    ? draftModes.includes(mode)
