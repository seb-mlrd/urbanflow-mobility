define(['exports'], function (t) {
  ...
  const l = {
    ...
    f = (t) => [u.prefix, t, u.suffix].filter((t) => t && t.length > 0).join('-'),
    w = (t) => t || f(u.precache),
    d = (t) => t || f(u.runtime);
  function p(t, e) {
    const s = new URL(t);
  ...
  ((t.CacheFirst = class extends v {
    ...
    (t.NetworkFirst = class extends v {
      constructor(t = {}) {
        (super(t),
          this.plugins.some((t) => 'cacheWillUpdate' in t) || this.plugins.unshift(l),
      ...
      async L(t, e) {
        ...
        let i;
        if (this.j) {
          const { id: s, promise: o } = this.M({ request: t, logs: n, handler: e });
          ((i = s), r.push(o));
        }
    ...
    (t.StaleWhileRevalidate = class extends v {
      constructor(t = {}) {
        (super(t), this.plugins.some((t) => 'cacheWillUpdate' in t) || this.plugins.unshift(l));
      }
      async L(t, e) {
